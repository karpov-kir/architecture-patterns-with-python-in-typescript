...
export class FakeProductRepository implements ProductRepository {
  ...
  get(sku: string): Promise<Product> {
    ...
    return productProperties
      ? Promise.resolve(new Product(clone(productProperties)))
  ...
  find(sku: string): Promise<Product | undefined> {
    ...
    return productProperties ? Promise.resolve(new Product(clone(productProperties))) : Promise.resolve(undefined);
  }
}
